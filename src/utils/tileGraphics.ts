...
export function getTileSVG(tile: Tile): string {
  ...
  switch (tile.type) {
    ...
    case 'tiao':
      ...
      break;
    case 'wan':
      body = `<text x="22" y="24" text-anchor="middle" dominant-baseline="central" font-size="22" font-weight="bold" fill="#2a52be" font-family="SimSun,serif">${NUM_CHARS[tile.value - 1]}</text>`
